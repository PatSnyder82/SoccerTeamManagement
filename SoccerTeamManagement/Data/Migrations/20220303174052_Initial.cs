...
namespace SoccerTeamManagement.Data.Migrations
{
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Person_Country_NationId",
                        column: x => x.NationId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Player_Country_NationId",
                        column: x => x.NationId,
                        principalTable: "Country",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.InsertData(
                table: "Person",
                columns: new[] { "Id", "AddressId", "DateOfBirth", "FirstName", "ImageId", "LastName", "NationId", "NickName", "PhoneId" },
                values: new object[,]
                {
                    { 901, 901, new DateTime(1984, 11, 13, 0, 0, 0, 0, DateTimeKind.Unspecified), "TestParentFirst1", null, "TestParentLast1", null, "TestParent 1", 901 },
                    { 902, 902, new DateTime(1985, 9, 5, 0, 0, 0, 0, DateTimeKind.Unspecified), "TestParentFirst2", null, "TestParentLast2", null, "TestParent 2", 902 },
                    { 903, 903, new DateTime(1986, 8, 3, 0, 0, 0, 0, DateTimeKind.Unspecified), "TestParentFirst3", null, "TestParentLast3", null, "TestParent 3", 903 },
                    { 904, 904, new DateTime(1987, 7, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "TestParentFirst4", null, "TestParentLast4", null, "TestParent 4", 904 },
                    { 905, 905, new DateTime(1988, 6, 17, 0, 0, 0, 0, DateTimeKind.Unspecified), "TestParentFirst5", null, "TestParentLast5", null, "TestParent 5", 905 },
                    { 906, 906, new DateTime(1989, 5, 28, 0, 0, 0, 0, DateTimeKind.Unspecified), "TestParentFirst6", null, "TestParentLast6", null, "TestParent 6", 906 },
                    { 907, 907, new DateTime(1990, 4, 13, 0, 0, 0, 0, DateTimeKind.Unspecified), "TestParentFirst7", null, "TestParentLast7", null, "TestParent 7", 907 },
                    { 908, 908, new DateTime(1967, 3, 20, 0, 0, 0, 0, DateTimeKind.Unspecified), "TestParentFirst8", null, "TestParentLast8", null, "TestParent 8", 908 },
                    { 909, 909, new DateTime(1968, 2, 26, 0, 0, 0, 0, DateTimeKind.Unspecified), "TestParentFirst9", null, "TestParentLast9", null, "TestParent 9", 909 },
                    { 910, 910, new DateTime(1954, 1, 12, 0, 0, 0, 0, DateTimeKind.Unspecified), "TestParentFirst10", null, "TestParentLast10", null, "TestParent 10", 910 },
                    { 911, 911, new DateTime(1978, 12, 24, 0, 0, 0, 0, DateTimeKind.Unspecified), "TestParentFirst11", null, "TestParentLast11", null, "TestParent 11", 911 },
                    { 912, 912, new DateTime(1999, 5, 13, 0, 0, 0, 0, DateTimeKind.Unspecified), "TestParentFirst12", null, "TestParentLast12", null, "TestParent 12", 912 }
                });

            migrationBuilder.InsertData(
                table: "Player",
                columns: new[] { "Id", "AddressId", "AttributesId", "DateOfBirth", "FirstName", "FlareRating", "Foot", "Height", "ImageId", "LastName", "NationId", "NickName", "PhoneId", "WeakFootRating", "Weight" },
                values: new object[,]
                {
                    { 912, 912, 912, new DateTime(2005, 12, 17, 0, 0, 0, 0, DateTimeKind.Unspecified), "Bob", 2, "Left", 59, null, "Smith", 210, "BoSmith", 912, 2, 180 },
                    { 911, 911, 911, new DateTime(1985, 11, 18, 0, 0, 0, 0, DateTimeKind.Unspecified), "Steve", 3, "Right", 74, null, "Rodgers", 235, "Captain America", 911, 1, 170 },
                    { 910, 910, 910, new DateTime(2006, 10, 19, 0, 0, 0, 0, DateTimeKind.Unspecified), "Thor", 5, "Right", 73, null, "Odinson", 10, "Thor", 910, 2, 160 },
                    { 909, 909, 909, new DateTime(1984, 9, 20, 0, 0, 0, 0, DateTimeKind.Unspecified), "Tony", 3, "Left", 72, null, "Stark", 84, "Iron Man", 909, 1, 200 },
                    { 908, 908, 908, new DateTime(2007, 8, 6, 0, 0, 0, 0, DateTimeKind.Unspecified), "Bruce", 3, "Right", 71, null, "Banner", 77, "Hulk", 908, 4, 190 },
                    { 907, 907, 907, new DateTime(1983, 7, 7, 0, 0, 0, 0, DateTimeKind.Unspecified), "Natasha", 4, "Right", 70, null, "Romanoff", 237, "Black Widow", 907, 1, 210 },
                    { 906, 906, 906, new DateTime(2008, 6, 8, 0, 0, 0, 0, DateTimeKind.Unspecified), "Oliver", 3, "Left", 69, null, "Queen", 237, "Green Arrow", 906, 3, 195 },
                    { 905, 905, 905, new DateTime(1982, 5, 9, 0, 0, 0, 0, DateTimeKind.Unspecified), "Diana", 3, "Right", 68, null, "Prince", 237, "Wonder Woman", 905, 1, 155 },
                    { 904, 904, 904, null, "Jack", 1, "Right", 67, null, "Reacher", 49, "Reacher", 904, 5, 165 },
                    { 903, 903, 903, new DateTime(1981, 3, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), "Bruce", 3, "Left", 66, null, "Wayne", 41, "Batman", 903, 1, 175 },
                    { 902, 902, 902, new DateTime(2010, 2, 11, 0, 0, 0, 0, DateTimeKind.Unspecified), "Peter", 3, "Right", 65, null, "Parker", 32, "Spiderman", 902, 4, 185 },
                    { 901, 901, 901, new DateTime(1980, 1, 12, 0, 0, 0, 0, DateTimeKind.Unspecified), "Clark", 2, "Right", 64, null, "Kent", 10, "Superman", 901, 1, 210 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 904, 901, new DateTimeOffset(new DateTime(2022, 3, 3, 12, 40, 51, 906, DateTimeKind.Unspecified).AddTicks(8574), new TimeSpan(0, -5, 0, 0, 0)), new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)) },
                    { 911, 903, new DateTimeOffset(new DateTime(2022, 3, 3, 12, 40, 51, 906, DateTimeKind.Unspecified).AddTicks(8607), new TimeSpan(0, -5, 0, 0, 0)), new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)) },
                    { 910, 903, new DateTimeOffset(new DateTime(2022, 3, 3, 12, 40, 51, 906, DateTimeKind.Unspecified).AddTicks(8603), new TimeSpan(0, -5, 0, 0, 0)), new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)) },
                    { 909, 903, new DateTimeOffset(new DateTime(2022, 3, 3, 12, 40, 51, 906, DateTimeKind.Unspecified).AddTicks(8598), new TimeSpan(0, -5, 0, 0, 0)), new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)) }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 908, 903, new DateTimeOffset(new DateTime(2022, 3, 3, 12, 40, 51, 906, DateTimeKind.Unspecified).AddTicks(8594), new TimeSpan(0, -5, 0, 0, 0)), new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)) },
                    { 901, 905, new DateTimeOffset(new DateTime(2022, 3, 3, 12, 40, 51, 906, DateTimeKind.Unspecified).AddTicks(8615), new TimeSpan(0, -5, 0, 0, 0)), new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)) },
                    { 907, 902, new DateTimeOffset(new DateTime(2022, 3, 3, 12, 40, 51, 906, DateTimeKind.Unspecified).AddTicks(8590), new TimeSpan(0, -5, 0, 0, 0)), new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)) },
                    { 906, 902, new DateTimeOffset(new DateTime(2022, 3, 3, 12, 40, 51, 906, DateTimeKind.Unspecified).AddTicks(8585), new TimeSpan(0, -5, 0, 0, 0)), new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)) },
                    { 902, 901, new DateTimeOffset(new DateTime(2022, 3, 3, 12, 40, 51, 906, DateTimeKind.Unspecified).AddTicks(8531), new TimeSpan(0, -5, 0, 0, 0)), new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)) },
                    { 905, 902, new DateTimeOffset(new DateTime(2022, 3, 3, 12, 40, 51, 906, DateTimeKind.Unspecified).AddTicks(8578), new TimeSpan(0, -5, 0, 0, 0)), new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)) },
                    { 903, 901, new DateTimeOffset(new DateTime(2022, 3, 3, 12, 40, 51, 906, DateTimeKind.Unspecified).AddTicks(8567), new TimeSpan(0, -5, 0, 0, 0)), new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)) },
                    { 901, 901, new DateTimeOffset(new DateTime(2022, 3, 3, 12, 40, 51, 904, DateTimeKind.Unspecified).AddTicks(622), new TimeSpan(0, -5, 0, 0, 0)), new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)) },
                    { 912, 904, new DateTimeOffset(new DateTime(2022, 3, 3, 12, 40, 51, 906, DateTimeKind.Unspecified).AddTicks(8611), new TimeSpan(0, -5, 0, 0, 0)), new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)) }
                });
