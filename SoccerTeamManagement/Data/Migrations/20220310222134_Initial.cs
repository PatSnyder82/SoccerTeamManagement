    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Team",
                columns: new[] { "Id", "ClubId", "LogoId", "Name" },
                values: new object[] { 901, 901, null, "Test Team 1" });

            migrationBuilder.InsertData(
                table: "Team",
                columns: new[] { "Id", "ClubId", "LogoId", "Name" },
                values: new object[] { 27, 27, null, "Toronto FC" });

            migrationBuilder.InsertData(
                table: "Team",
                columns: new[] { "Id", "ClubId", "LogoId", "Name" },
                values: new object[] { 1, 1, null, "Atlanta United" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 904, 901, new DateTimeOffset(new DateTime(2022, 3, 10, 17, 21, 33, 824, DateTimeKind.Unspecified).AddTicks(2004), new TimeSpan(0, -5, 0, 0, 0)), new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)) });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 909, 903, new DateTimeOffset(new DateTime(2022, 3, 10, 17, 21, 33, 824, DateTimeKind.Unspecified).AddTicks(2100), new TimeSpan(0, -5, 0, 0, 0)), new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)) },
                    { 905, 902, new DateTimeOffset(new DateTime(2022, 3, 10, 17, 21, 33, 824, DateTimeKind.Unspecified).AddTicks(2020), new TimeSpan(0, -5, 0, 0, 0)), new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)) },
                    { 911, 903, new DateTimeOffset(new DateTime(2022, 3, 10, 17, 21, 33, 824, DateTimeKind.Unspecified).AddTicks(2225), new TimeSpan(0, -5, 0, 0, 0)), new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)) },
                    { 903, 901, new DateTimeOffset(new DateTime(2022, 3, 10, 17, 21, 33, 824, DateTimeKind.Unspecified).AddTicks(1985), new TimeSpan(0, -5, 0, 0, 0)), new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)) },
                    { 902, 901, new DateTimeOffset(new DateTime(2022, 3, 10, 17, 21, 33, 824, DateTimeKind.Unspecified).AddTicks(1902), new TimeSpan(0, -5, 0, 0, 0)), new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)) },
                    { 910, 903, new DateTimeOffset(new DateTime(2022, 3, 10, 17, 21, 33, 824, DateTimeKind.Unspecified).AddTicks(2122), new TimeSpan(0, -5, 0, 0, 0)), new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)) },
                    { 901, 901, new DateTimeOffset(new DateTime(2022, 3, 10, 17, 21, 33, 818, DateTimeKind.Unspecified).AddTicks(7586), new TimeSpan(0, -5, 0, 0, 0)), new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)) },
                    { 901, 905, new DateTimeOffset(new DateTime(2022, 3, 10, 17, 21, 33, 824, DateTimeKind.Unspecified).AddTicks(2263), new TimeSpan(0, -5, 0, 0, 0)), new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)) },
                    { 908, 903, new DateTimeOffset(new DateTime(2022, 3, 10, 17, 21, 33, 824, DateTimeKind.Unspecified).AddTicks(2080), new TimeSpan(0, -5, 0, 0, 0)), new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)) },
                    { 906, 902, new DateTimeOffset(new DateTime(2022, 3, 10, 17, 21, 33, 824, DateTimeKind.Unspecified).AddTicks(2046), new TimeSpan(0, -5, 0, 0, 0)), new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)) },
                    { 907, 902, new DateTimeOffset(new DateTime(2022, 3, 10, 17, 21, 33, 824, DateTimeKind.Unspecified).AddTicks(2063), new TimeSpan(0, -5, 0, 0, 0)), new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)) },
                    { 912, 904, new DateTimeOffset(new DateTime(2022, 3, 10, 17, 21, 33, 824, DateTimeKind.Unspecified).AddTicks(2246), new TimeSpan(0, -5, 0, 0, 0)), new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)) }
                });
