...
import { LogoutActions, ApplicationPaths, ReturnUrlType } from '../../../../constants/api-authorization.constants';

// The main responsibility of this component is to handle the user's logout process.
// This is the starting point for the logout process, which is usually initiated when a
// user clicks on the logout button on the LoginMenu component.
@Component({
  selector: 'sm-api-auth-logout',
  templateUrl: './api-auth-logout.component.html',
  styleUrls: ['./api-auth-logout.component.scss']
})
export class ApiAuthLogoutComponent implements OnInit {
